# HUNGER Restaurant Billing System - PowerShell Installer
# Complete desktop billing system installer

param(
    [string]$InstallDir = "${env:PROGRAMFILES}\HUNGER Restaurant Billing System"
)
...
function Create-Shortcuts {
    ...
    $DesktopShortcut = Join-Path $Desktop "HUNGER Restaurant Billing System.lnk"
    ...
    $StartMenuShortcut = Join-Path $StartMenu "Programs\HUNGER Restaurant Billing System.lnk"
...
Write-Host "Desktop Installer v1.0.0" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($success) {
    ...
    Write-Host "1. Double-click the desktop shortcut 'HUNGER Restaurant Billing System'" -ForegroundColor White
    Write-Host "2. Or run: $InstallDir\start_desktop.bat" -ForegroundColor White
    Write-Host "3. Or go to Start Menu > HUNGER Restaurant Billing System" -ForegroundColor White
    Write-Host ""
